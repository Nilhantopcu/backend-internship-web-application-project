...
let CoordinatorRepository = class CoordinatorRepository extends typeorm_1.Repository {
    constructor(dataSource) {
        super(coordinator_entity_1.Coordinator, dataSource.createEntityManager());
        this.dataSource = dataSource;
    }
    async createCoordinator(createCoordinatorDto) {
